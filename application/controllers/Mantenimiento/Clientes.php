...
class CLientes extends BaseController
{
    ...
    public function guardarClientes()
    {
        ...
        $this->form_validation->set_rules('numero_documento', 'Numero de documento', 'is_unique[clientes.num_documento]');
    ...
    public function actualizarCliente()
    {
        ...
        $this->form_validation->set_rules('numero_documento', 'Numero de documento'  . $is_unique);
