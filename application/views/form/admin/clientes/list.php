                     ...
                     <div class="x_panel">
                         ...
                         <div class="x_content">
                             ...
                             <form method="POST" action="<?php echo base_url(); ?>Mantenimiento/Clientes/guardarClientes" id="clientes" class="form-horizontal form-label-left">
                                 ...
                                 <div class="form-group">
                                     <label for="direccion" class="control-label col-md-3 col-sm-3 col-xs-12">Departamento <span class="required">*</span></label>
                                     <div class="col-md-4 col-sm-6 col-xs-12">
                                         <input type="text" name="departamento" id="departamento" required="required" class="form-control col-md-7 col-xs-12" placeholder="Escriba la direccion">
