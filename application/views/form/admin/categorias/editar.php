                 ...
                 <form method="POST" action="<?php echo base_url();?>Mantenimiento/Categorias/actualizarCategoria" id="categorias" class="form-horizontal form-label-left">
                    ...
                    <div class="form-group <?php echo !empty(form_error("nombre"))?'has-error':'';?>">
                         ...
                         <div class="col-md-4 col-sm-6 col-xs-12">
                             <input type="text" name="nombre" id=nombre value="<?php echo !empty(form_error("nombre"))? set_value("nombre"):$categoria->nombre ?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Nombre de la Categoria">
                     ...
                     <div class="form-group">
                         ...
                         <div class="col-md-4 col-sm-6 col-xs-12">
                             <input type="text" name="descripcion" id="descripcion" value="<?php echo $categoria->descripcion ?>" required="required" class="form-control col-md-7 col-xs-12" placeholder="Escriba una descripcion breve">
